...
echo "   Upload the following files to the ZK circuits CDN:"
echo "   - src/features/zk/circuits/identity_with_merkle_js/identity_with_merkle.wasm"
echo "   - src/features/zk/keys/identity_with_merkle_0001.zkey (as identity_with_merkle_final.zkey)"
echo "   - src/features/zk/keys/verification_key_merkle.json"
echo "   See internal deployment docs for CDN access details."
echo ""
