...
`better_testing/` is the local devnet validation harness for the node repo. It covers:
...
| Run one specific scenario | `better_testing/scripts/run-scenario.sh <scenario> [--build]` |
...
better_testing/scripts/run-scenario.sh multichain_parser_execute_smoke --build
...
- `better_testing/runs/<RUN_ID>/`
- `better_testing/runs/_latest/`
...
- `better_testing/TESTING_MAP.md`
  - visual overview
- `better_testing/scripts/README.md`
...
- `history/better_testing/ASSESSMENT.2026-03-snapshot.md`
- `history/better_testing/AUDIT_REPORT.2026-03-snapshot.md`

## Outdated Material Policy

Live documentation in `better_testing/` should do one of two things:
