...
Read `better_testing/README.md` first. This file explains the narrow question: how individual scenarios are executed.
...
```bash
SCENARIO=<name> bun better_testing/loadgen/src/main.ts
```
...
better_testing/scripts/run-scenario.sh multichain_parser_execute_smoke
```
