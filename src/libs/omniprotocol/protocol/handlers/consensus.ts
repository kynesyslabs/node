 ...
 */
export const handleProposeBlockHash: OmniHandler<Buffer> = async ({
    message,
    context,
}) => {
    if (
    ...
    try {
        ...
        const { default: manageConsensusRoutines } =
            await import("../../../network/manageConsensusRoutines")
        ...
        const httpResponse = await manageConsensusRoutines(
        ...
        return encodeProposeBlockHashResponse({
            ...
            signatures:
                (httpResponse.extra?.signatures as Record<string, string>) ??
                {},
 ...
 */
export const handleSetValidatorPhase: OmniHandler<Buffer> = async ({
    message,
    context,
}) => {
    if (
 ...
 */
export const handleGreenlight: OmniHandler<Buffer> = async ({
    message,
    context,
}) => {
    if (
...
export const handleGetValidatorPhase: OmniHandler<Buffer> = async () => {
    try {
        ...
        const phase =
            typeof httpResponse.response === "number"
