...
export type UnsSol = {
    ...
    instructions: [
        ...
        {
            name: "addRecord"
            discriminator: [65, 186, 219, 131, 44, 66, 61, 216]
            accounts: [
                {
                    name: "recordPda"
                    writable: true
        ...
        },
        {
            ...
            discriminator: [62, 57, 203, 191, 182, 36, 55, 227]
            accounts: [
                {
                    name: "recordPda"
                    writable: true
        ...
        {
            name: "createTld"
            discriminator: [216, 213, 126, 50, 156, 194, 18, 83]
            accounts: [
                {
                    name: "tld"
                    writable: true
        ...
        {
            name: "mintSld"
            discriminator: [152, 18, 50, 213, 45, 11, 111, 104]
            accounts: [
                {
                    name: "sldMint"
                    writable: true
        ...
        {
            name: "removeRecord"
            discriminator: [57, 165, 122, 26, 131, 148, 234, 99]
            accounts: [
                {
                    name: "recordPda"
                    writable: true
        ...
        },
        {
            ...
            discriminator: [174, 193, 102, 17, 111, 131, 144, 29]
            accounts: [
                {
                    name: "recordPda"
                    writable: true
        ...
        {
            name: "removeTld"
            discriminator: [117, 218, 124, 196, 193, 44, 131, 232]
            accounts: [
                {
                    name: "tld"
                    writable: true
        ...
        {
            name: "setExpiration"
            discriminator: [17, 250, 26, 178, 132, 169, 26, 51]
            accounts: [
                {
                    name: "domainProperties"
                    writable: true
        ...
        },
        {
            ...
            discriminator: [184, 226, 230, 170, 30, 120, 229, 9]
            accounts: [
                {
                    name: "sldMint"
                    writable: true
        ...
        },
        {
            ...
            discriminator: [15, 214, 181, 183, 136, 194, 245, 18]
            accounts: [
                {
                    name: "programAuthority"
                    writable: true
        ...
        {
            name: "updateRecord"
            discriminator: [54, 194, 108, 162, 199, 12, 5, 60]
            accounts: [
                {
                    name: "recordPda"
                    writable: true
    ...
    accounts: [
        {
            name: "domainProperties"
            discriminator: [247, 96, 98, 87, 105, 137, 116, 194]
        },
        {
            name: "minter"
        ...
        {
            name: "programAuthority"
            discriminator: [38, 198, 188, 60, 171, 210, 169, 38]
        },
        {
            name: "record"
            discriminator: [254, 233, 117, 252, 76, 166, 146, 139]
        },
        {
            name: "tld"
            discriminator: [53, 129, 84, 201, 157, 33, 4, 97]
        },
    ]
    events: [
        {
            name: "domainMinted"
            discriminator: [92, 202, 134, 57, 185, 96, 136, 58]
        },
        {
            name: "expirationSet"
            discriminator: [113, 224, 108, 51, 249, 235, 173, 41]
        },
        {
            name: "recordAdded"
            discriminator: [220, 101, 67, 16, 19, 60, 90, 35]
        },
        {
            name: "recordRemoved"
            discriminator: [26, 50, 240, 190, 55, 53, 183, 214]
        },
        {
            name: "recordUpdated"
            discriminator: [22, 215, 203, 119, 23, 134, 237, 84]
        },
        {
            name: "tldAdded"
            discriminator: [6, 18, 164, 57, 6, 223, 50, 6]
        },
        {
            name: "tldRemoved"
            discriminator: [91, 19, 81, 29, 244, 154, 29, 208]
        },
        {
            name: "transfer"
