...
export default async function handleAptosContractRead(
    ...
    try {
        ...
        console.log(`calling Move view function: ${params.moduleAddress}::${params.moduleName}::${params.functionName}`)
        ...
        const result = await aptosInstance.readFromContract(
