...
export class Prover {
  ...
  constructor(prime1: any, prime2: any, secret: bigInt.BigInteger = null) {
  ...
  respondToChallenge(challenge: number): any {
    return challenge === 0 ? this.randomValue : this.randomValue.multiply(this.secret).mod(this.modulus);
  }
}
