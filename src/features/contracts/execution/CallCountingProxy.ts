...
export function createCallCountingProxy<T extends object>(
    ...
    const allExcludedMethods = new Set([...defaultExcludedMethods, ...excludeMethods])
    ...
    return new Proxy(target, {
        get(obj: T, prop: string | symbol): any {
            ...
            if (typeof value === "function") {
                ...
                // Check if method name starts with underscore (private/internal methods)
                ...
                return function(...args: any[]) {
                    ...
                    console.log(`[CallCountingProxy] Function '${String(prop)}' called. Total calls: ${callCounter.count}`)
