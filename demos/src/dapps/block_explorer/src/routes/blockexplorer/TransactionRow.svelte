...
<div class="block-card">
        ...
        <div style="width: 100%;">
            {#if transaction}
                <div class="number-section">
                    ...
                    <a href={`/blockexplorer/transactions/${transaction.hash}`} class="accessible loaded"><p class="block-number">{trim_address(transaction.hash, address_section_width)}</p></a>
                </div>
    ...
    <div id="address_section">
        {#if transaction}
            <p class="loaded delayed2" style="margin-top:0;margin-bottom:8px;">From <span class="fake-link">{trim_address(transaction.content.from, address_section_width)}</span></p>
            <p class="loaded delayed3" style="margin: 0;">To <span class="fake-link">{trim_address(transaction.content.to, address_section_width)}</span></p>
        {:else}
            <div class="skeletonplaceholder delayed2" style="margin-bottom:8px;height:18px;"></div>
