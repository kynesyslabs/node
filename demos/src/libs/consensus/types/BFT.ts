...
export default class QBFT {
    ...
    static async representationAssembly(shard: any /* TODO Typize it */): Promise<[boolean, Block]> {
    ...
    static async vote(parameter: any, our: any): Promise<boolean> {
        ...
        return QBFT.checkConsensus(numericResult.pro, numericResult.con, numericResult.total)
    }

    // INFO Checking a generic consensus BFT
    private static checkConsensus(pro: number, con: number, total: number): boolean {
