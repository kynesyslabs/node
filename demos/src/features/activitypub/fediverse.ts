...
app.get("/:collection/:id", (req: { params: { collection: any; id: any; }; }, res: any) => {
...
app.put("/:collection/:id", (req: { params: { collection: any; id: any; }; body: any; }, res: any) => {
  const { collection, id } = req.params
...
app.listen(port, () => {console.log(`ActivityPub server listening on port ${port}`); connected = true })
