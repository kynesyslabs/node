...
async function testing() {
    ...
    const verified = await enigma.verify(signature, message, enigma.signingKeyPair.publicKey, additionalData)
	...
	console.log("\n[Encryption] Pretending to be someon else...\n")
	console.log("[ALICE] [Encryption] We received a shared secret from the peer!")
	//console.log(sharedSecret.shared)
	console.log("[ALICE] [Encryption] Deriving the real secret using our private key...")
